...
app.post('/api/logs/:id/finalize', async (req, res) => {
  try {
    ...
    /*
      The requested UserLogs architecture contains fieldData1,
      fieldData2 and fieldData3 but no dedicated status field.

      Therefore the execution confirmation state is stored in
      fieldData3 while preserving the requested schema.
    */
